...
PDF_PATH = "D:\git\LangGraph\LangGraph_Learning\langsmith-masterclass\islr.pdf"  # <- change to your file

# ----------------- helpers (not traced individually) -----------------
#when many traceble that time use metadata for help searching in LangSmith 
...
@traceable(name="build_vectorstore", tags = ['embedding', 'VectorStore'], 
           metadata={'embedding-model': 'sentence-transformer'})
